...
const SITE_KEY = '6LfIOWMrAAAAABf3T4h9AdLgqyVHkJy8X-aFQMW-'
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {isSubmitted ? (
          <>
            ...
            <Button className={s.sendBtn} type={'submit'} fullwidth style={{ marginTop: '10px' }}>
              Send Link Again
            </Button>
          ...
          <>
            <Button className={s.sendBtn} type={'submit'} fullwidth disabled={!isValid}>
              Send Link
            </Button>
            <Link href={ROUTES.AUTH.SIGN_IN} passHref legacyBehavior>
              <Button className={s.signInBtn} as={'a'} variant={'link'}>
