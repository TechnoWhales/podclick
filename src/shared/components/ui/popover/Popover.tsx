...
export const Popover = ({
  ...
  <PopoverPrimitive.Root>
    <PopoverPrimitive.Trigger asChild>
      <Button
        variant={'icon'}
        className={clsx(s.IconButton, typeof buttonText === 'string' && s.text)}
    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        className={clsx(s.Content, showCloseIcon && s.closeIcon)}
      ...
      >
        {children}
        {showCloseIcon && (
          <PopoverPrimitive.Close className={s.Close} aria-label={'Close'}>
            <Cross2Icon />
